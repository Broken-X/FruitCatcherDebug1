                    ...
                    console.log(allPlayers[plr]);
                     ...
                     if(index === player.index){
                        ...
                        if (index === 1) {
                            ...
                            text(name1, players[index-1].x-20, players[index-1].y+20)
                        } else if (index === 2) {
                            console.log(plr[index-1].x);
                            text(name2, players[index-1].x-20, players[index-1].y+20)
                        }
